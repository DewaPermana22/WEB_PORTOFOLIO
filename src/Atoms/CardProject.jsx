  ...
  return (
    <div className='bg-white w-[500px] dark:bg-gray-900 rounded-xl'>
        <div className='flex flex-col gap-2 p-5'>
            <div>
               <img className='w-full' src="/project1.jpg" alt="" />
            </div>
            ...
            <h1 className='px-5 font-Roboto_bold text-lg text-justify'>Using : </h1>
        </div>
        <div className='flex gap-5 pb-5 px-7'><FlutterIcon />
