...
function Footer() {
  return (
    <footer className="flex flex-col max-sm:pt-14  p-5 bg-slate-100 dark:bg-gray-900 transition-colors duration-300 ease-in-out border-t border-gray-300 shadow-lg dark:border-purple-700">
