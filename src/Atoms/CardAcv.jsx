...
function CardAcv({text}) {
  return (
    <motion.div whileHover={{translateY: -12}} className='dark:border-dasharray dark:border-purple-700 dark:border-spacing-32 flex flex-col w-[400px] border rounded-lg bg-slate-100 dark:bg-gray-900 border-gray-900 transition-colors duration-300 ease-in-out p-9 max-[393px]:w-[350px] '>
